...
## Current main file
- `2026I.A.Watson_plots.geojson` — fitted YYYY-MM-DD by <name>,
...
| --- | --- | --- | --- |
| `2026I.A.Watson_plots_YYYYMMDD_deprecated.geojson` | YYYY-MM-DD | <reason> | `2026I.A.Watson_plots.geojson` |
