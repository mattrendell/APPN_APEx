...
## Current main file
- `2026Narrabri_plots.geojson` — fitted YYYY-MM-DD by <name>,
...
| --- | --- | --- | --- |
| `2026Narrabri_plots_YYYYMMDD_deprecated.geojson` | YYYY-MM-DD | <reason> | `2026Narrabri_plots.geojson` |
