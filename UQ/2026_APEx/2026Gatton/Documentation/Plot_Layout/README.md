...
## Current main file
- `2026Gatton_plots.geojson` — fitted YYYY-MM-DD by <name>,
...
| --- | --- | --- | --- |
| `2026Gatton_plots_YYYYMMDD_deprecated.geojson` | YYYY-MM-DD | <reason> | `2026Gatton_plots.geojson` |
