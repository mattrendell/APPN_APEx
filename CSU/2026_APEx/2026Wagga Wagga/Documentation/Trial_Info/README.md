...
- `2026Wagga Wagga_trial_info.csv` — source: <spreadsheet / contact>,
...
| --- | --- | --- | --- |
| `2026Wagga Wagga_trial_info_YYYYMMDD_deprecated.csv` | YYYY-MM-DD | <reason> | `2026Wagga Wagga_trial_info.csv` |
