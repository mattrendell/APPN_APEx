...
## Current main file
- `2026Wagga Wagga_plots.geojson` — fitted YYYY-MM-DD by <name>,
...
| --- | --- | --- | --- |
| `2026Wagga Wagga_plots_YYYYMMDD_deprecated.geojson` | YYYY-MM-DD | <reason> | `2026Wagga Wagga_plots.geojson` |
